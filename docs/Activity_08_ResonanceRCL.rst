...
- Widerstände 100 :math:`\Omega`, 1 :math:`k\Omega`
...
1. Bauen Sie die RLC-Schaltung wie in Abbildung 8 auf Ihrer lötfreien
   Leiterplatte mit den Bauteilwerten RS = 100 :math:`\Omega`, R1 = 1 :math:`k\Omega`, C1 = 0,1
...
4. Wiederholen Sie das Experiment für den Serienschwingkreis in Figur
   3 und verwenden Sie L1 = 20 mH und C1 = 0,01 uF und R1 = 1 :math:`k\Omega`. Die
