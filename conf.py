...
htmlhelp_basename = 'ActiveLearning-de_doc'
...
latex_documents = [
    (master_doc, 'ActiveLearning-de.tex', u'ActiveLearning-de Dokumentation', u'M. Meiners',
     'manual'),
]
...
man_pages = [(master_doc, 'activelearning-de', u'ActiveLearning-de Dokumentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'ActiveLearning-de', u'ActiveLearning-de Dokumentation', author, 'ActiveLearning-de',
